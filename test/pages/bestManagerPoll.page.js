...
class bestManagerPoll extends Page {
    ...
    get totalVotes() {
        return $(
            "#PDI_container9721073 > div > div > div > div > div.pds-answer > div:nth-child(1) > label > span.pds-feedback-result > span.pds-feedback-per"
        );
    }
    open() {
        super.open(
            "2017/04/12/quien-fue-el-mejor-dt-de-la-seleccion-en-los-ultimos-25-anos"
        );
    }
