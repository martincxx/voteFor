...
class worstManagerPoll extends Page {
    ...
    get totalVotes() {
        return $(
            "#PDI_container9721076 > div > div > div > div > div.pds-answer > div:nth-child(1) > label > span.pds-feedback-result > span.pds-feedback-per"
        );
    }
    open() {
        super.open(
            "2017/04/13/quien-fue-el-peor-dt-de-la-seleccion-en-los-ultimos-25-anos"
        );
    }
